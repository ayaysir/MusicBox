...
class AppExhibitionTableViewController: UITableViewController {
  ...
  private let infos: [AppInfo] = [
    AppInfo(
      title: "Music Interval Quiz Master",
      description: "description_IntervalMaster",
      imgAssetName: "icon-IntervalQuiz",
      appStoreID: "6738980588"
    ),
    AppInfo(
      title: "UltimateScale",
      description: "description_UltimateScale",
      imgAssetName: "icon-UltimateScale",
      appStoreID: "1631310626"
    ),
    AppInfo(
      title: "Tuner XR",
      description: "description_TunerXR",
      imgAssetName: "icon-TunerXR",
      appStoreID: "1581803256"
    ),
    AppInfo(
      title: "DiffuserStick",
      description: "description_DiffuserStick",
